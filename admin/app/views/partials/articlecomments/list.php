...
<section class="page ajax-page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="grid" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Articlecomments</h4>
                </div>
                <div class="col-sm-3 ">
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("articlecomments/add") ?>">
                        <i class="fa fa-plus"></i>                              
                        Add New Articlecomments 
                    </a>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('articlecomments'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('articlecomments'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="articlecomments-list-records">
                                <?php
                                if(!empty($records)){
                                ?>
