                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-bio"  value="<?php  echo $this->set_field_value('bio',""); ?>" type="text" placeholder="Enter Bio"  name="bio"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <?php 
                                                                    $gender_options = $comp_model -> users_gender_option_list();
                                                                    ...
                                                                    <label class="custom-control custom-radio custom-control-inline">
                                                                        <input id="ctrl-gender" class="custom-control-input" <?php echo $checked; ?> value="<?php echo $value; ?>" type="radio"  name="gender"   required="" />
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-firstname"  value="<?php  echo $this->set_field_value('firstname',""); ?>" type="text" placeholder="Enter Firstname"  name="firstname"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-middlename"  value="<?php  echo $this->set_field_value('middlename',""); ?>" type="text" placeholder="Enter Middlename"  name="middlename"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-lastname"  value="<?php  echo $this->set_field_value('lastname',""); ?>" type="text" placeholder="Enter Lastname"  name="lastname"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
