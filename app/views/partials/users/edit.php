                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-bio"  value="<?php  echo $data['bio']; ?>" type="text" placeholder="Enter Bio"  name="bio"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-firstname"  value="<?php  echo $data['firstname']; ?>" type="text" placeholder="Enter Firstname"  name="firstname"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-lastname"  value="<?php  echo $data['lastname']; ?>" type="text" placeholder="Enter Lastname"  name="lastname"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
