                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-auto_approve_posts">
                                        <th class="title"> Auto Approve Posts: </th>
                                        <td class="value"> <?php echo $data['auto_approve_posts']; ?></td>
                                    </tr>
                                    <tr  class="td-admin_mail">
                                        <th class="title"> Admin Mail: </th>
                                        <td class="value"> <?php echo $data['admin_mail']; ?></td>
                                    </tr>
                                    <tr  class="td-mail_admin_post">
                                        <th class="title"> Mail Admin Post: </th>
                                        <td class="value"> <?php echo $data['mail_admin_post']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
