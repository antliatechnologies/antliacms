                                    ...
                                    <table class="table table-hover table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-auto_approve_posts"> Auto Approve Posts</th>
                                                <th  class="td-admin_mail"> Admin Mail</th>
                                                <th  class="td-mail_admin_post"> Mail Admin Post</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-auto_approve_posts"> <?php echo $data['auto_approve_posts']; ?></td>
                                                    <td class="td-admin_mail"> <?php echo $data['admin_mail']; ?></td>
                                                    <td class="td-mail_admin_post"> <?php echo $data['mail_admin_post']; ?></td>
                                                    <th class="td-btn">
